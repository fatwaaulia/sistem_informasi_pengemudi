                ...
                <div class="card-body">
                    <form action="<?= $base_route . '/create' ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control <?= validation_show_error('no_sim') ? 'is-invalid' : '' ?>" id="no_sim" name="no_sim" value="<?= old('no_sim') ?>" placeholder="masukkan nomor sim">
                            <div class="invalid-feedback">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                ...
                                <div class="col-md-6 position-relative">
                                    <img src="<?= base_url('assets/uploads/default.png') ?>" class="w-100 img-style <?= validation_show_error('foto_ktp') ? 'border border-danger' : '' ?>" id="frame2">
                                    <div class="position-absolute" style="bottom:0px;right:0px">
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                ...
                                <div class="col-md-6 position-relative">
                                    <img src="<?= base_url('assets/uploads/default.png') ?>" class="w-100 img-style <?= validation_show_error('foto_sim') ? 'border border-danger' : '' ?>" id="frame3">
                                    <div class="position-absolute" style="bottom:0px;right:0px">
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                ...
                                <div class="col-md-6 position-relative">
                                    <img src="<?= base_url('assets/uploads/default.png') ?>" class="w-100 img-style <?= validation_show_error('foto_temuan') ? 'border border-danger' : '' ?>" id="frame4">
                                    <div class="position-absolute" style="bottom:0px;right:0px">
