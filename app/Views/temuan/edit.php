                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control <?= validation_show_error('rincian') ? 'is-invalid' : '' ?>" id="rincian" name="rincian" rows="3" placeholder="masukkan rincian"><?= old('rincian') ?? $data['rincian'] ?></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control <?= validation_show_error('tanggal') ? 'is-invalid' : '' ?>" id="tanggal" name="tanggal" value="<?= old('tanggal') ?? $data['tanggal'] ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    <div class="col-md-6 position-relative">
                                        <?php
                                        $bukti = ($data['bukti'])
                                            ? base_url('assets/uploads/temuan/' . $data['bukti'])
                                            : base_url('assets/uploads/default.png');
                                        ?>
                                        <img src="<?= $bukti ?>" class="w-100 img-style <?= validation_show_error('bukti') ? 'border border-danger' : '' ?>" id="frame">
