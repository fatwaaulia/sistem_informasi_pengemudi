                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <div class="col-md-6 position-relative">
                                        <?php
                                        $gambar = ($data['gambar'])
                                            ? base_url('assets/uploads/form_input/' . $data['gambar'])
                                            : base_url('assets/uploads/default.png');
                                        ?>
                                        <img src="<?= $gambar ?>" class="w-100 img-style <?= validation_show_error('gambar') ? 'border border-danger' : '' ?>" id="frame">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control <?= validation_show_error('harga') ? 'is-invalid' : '' ?>" id="harga" name="harga" value="<?= old('harga') ?? $data['harga'] ?>" placeholder="299000" onkeydown="if(/[.,]/.test(event.key)) event.preventDefault();">
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control <?= validation_show_error('tanggal_kegiatan') ? 'is-invalid' : '' ?>" id="tanggal_kegiatan" name="tanggal_kegiatan" value="<?= old('tanggal_kegiatan') ?? $data['tanggal_kegiatan'] ?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select <?= validation_show_error('select_multiple') ? 'is-invalid' : '' ?>" id="select_multiple" name="select_multiple[]" multiple>
                                        ...
                                        $selected = old('select_multiple', (array)json_decode($data['select_multiple'], true));
                                ...
                                <div class="mb-3">
                                    ...
                                    $checked = old('checkbox', (array)json_decode($data['checkbox'], true));
                                ...
                                <div class="mb-3">
                                    ...
                                    $checked = old('radio', $data['radio']);
                                    foreach($radio as $v) :
                                    ?>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" id="<?= $v ?>" name="radio" value="<?= $v ?>" <?= $checked == $v ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="<?= $v ?>">
                                            <?= $v ?>
                                        </label>
                                    </div>
